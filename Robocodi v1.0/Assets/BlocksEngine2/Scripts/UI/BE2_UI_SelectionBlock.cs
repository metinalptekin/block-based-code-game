...
namespace MG_BlocksEngine2.UI
{
    ...
    public class BE2_UI_SelectionBlock : MonoBehaviour
    {
        ...
        void PerformClean()
        {
            ...
            int count0 = Mathf.Min(transform.childCount, prefabBlock.transform.childCount);
            for (int i = 0; i < count0; i++)
            {
                ...
                int count1 = Mathf.Min(child0.childCount, pref0.childCount);
                for (int j = 0; j < count1; j++)
                {
                    ...
                    int count2 = Mathf.Min(child1.childCount, pref1.childCount);
